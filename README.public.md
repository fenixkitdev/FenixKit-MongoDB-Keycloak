# FenixKit — .NET 8 Minimal API  MongoDB + Keycloak Auth

> **Ship faster. Build smarter.**  
> A production-ready .NET 8 Minimal API starter with Keycloak JWT authentication, MongoDB, and zero manual setup.
